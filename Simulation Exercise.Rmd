...
## Overview
The main purpose of the data analysis is to investigate the exponential distribution
and then compare it to the Central Limit Theorem (CLT). For this analysis, the lambda will 
...
#### Comparison
There is only a little difference between the simulations sample mean and the 
...
normal distribution. Which have a mean of lambda^-1 and standard deviation of 
